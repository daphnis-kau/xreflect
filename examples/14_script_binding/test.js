...
(function () 
{
    ...
    XJS.class(CApplicationHandler, null, IApplicationHandler);
    ...
    window.StartApplication = function(name, id) 
    {
        ...
        var mapTest = g_App.TestTemplateMap( 987654, "TestMapValue" );
        var Begin = mapTest.begin().Value();
        Test( Begin.first == 987654 && Begin.second.c_str() == "TestMapValue", "Test Template iterator" );
